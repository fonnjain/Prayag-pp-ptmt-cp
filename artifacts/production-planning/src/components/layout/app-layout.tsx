          ...
          <div className="px-4 pt-4 pb-3 border-b border-sidebar-border space-y-2.5">
            ...
            <label className="block text-[11px] font-semibold text-muted-foreground">
              ...
              <select
                ...
                onChange={(event) => monthState.setMonth(event.target.value)}
                className="mt-1 h-8 w-full rounded-md border border-sidebar-border bg-background px-2 text-xs font-normal text-foreground"
              >
            ...
            {monthState.isFallback && monthState.fallbackFrom && (
              <div className="rounded-md border border-amber-300 bg-amber-50 px-2.5 py-2 text-[11px] leading-4 text-amber-900">
                <strong>
                  Showing {formatMonthLabel(monthState.month)} — {formatMonthLabel(monthState.fallbackFrom)} has not run yet.
                </strong>{" "}
                {formatMonthLabel(monthState.fallbackFrom)}'s input files have not been uploaded.
                <button
                  type="button"
            ...
            {monthState.invalidMonth && (
              <div className="rounded-md border border-red-200 bg-red-50 px-2.5 py-2 text-[11px] leading-4 text-red-800">
