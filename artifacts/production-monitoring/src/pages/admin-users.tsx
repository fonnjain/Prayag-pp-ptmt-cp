...
export default function AdminUsersPage() {
  ...
  // Only admins can reach this page (App.tsx guards the route)
  if (me?.role !== "admin") {
    return (
        ...
        <DialogContent>
          ...
          <form id="reset-pw-form" onSubmit={(e) => { void handleReset(e); }} className="space-y-4 py-2">
            <div className="space-y-1.5">
              ...
              <p className="text-xs text-muted-foreground">The user's active sessions will be invalidated. They must sign in again with this password and will be prompted to change it.</p>
            </div>
          </form>
          <DialogFooter>
